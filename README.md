...
local function isPlayerVisibleThroughWalls(player, trg_part)
    ...
    local hit,  = workspace:FindPartOnRayWithIgnoreList(ray, {localPlayerCharacter})
    ...
    local nearHit,  = workspace:FindPartOnRayWithIgnoreList(nearRay, {localPlayerCharacter})
